            ...
            <div className="max-w-4xl mx-auto">
              ...
              <ScrollReveal delay={100}>
                ...
                <p className="text-sm md:text-base text-black leading-relaxed mb-12">
                  {"Newceはミッション、ビジョンを達成するための行動指標として、4つのバリューを定めています。採用基準から、人事評価、日々の業務、そして経��判断まで、Newceに関わる全ての意思決定はこの4つのバリューをもとに行われています。個人や組織に共通のバリューがあることにより、意思決定を加速させることができます。"}
                </p>
              </ScrollReveal>
